...
struct MainScreenSlotEditorOverlay: View {
    ...
    private let colorKeyCodes: [(code: String?, label: String?, color: Color)] = [
			...
			("FF0000", "y",   	Color(hex: "FF0000")),
			("910000", "",     	Color(hex: "910000")),
			("C97827", "",   	Color(hex: "C97827")),
			("5E3812", "",     	Color(hex: "5E3812")),

			("8A8A8A", "",     	Color(hex: "8A8A8A")),
			("0000FF", "",     	Color(hex: "0000FF")),
			("171775", "",     	Color(hex: "171775")),
			("919100", "",     	Color(hex: "919100")),
			("595900", "",     	Color(hex: "595900")),

			("424242", "",     	Color(hex: "424242")),
			("00A600", "",     	Color(hex: "00A600")),
			("004F00", "",     	Color(hex: "004F00")),
			("D42AD4", "",     	Color(hex: "D42AD4")),
			("870087", "",     	Color(hex: "870087")),

			("21A3A3", "",     	Color(hex: "21A3A3")),
			("CC1451", "",     	Color(hex: "CC1451")),
			("CC7AA3", "",     	Color(hex: "CC7AA3")),
			("CCCC00", "",     	Color(hex: "CCCC00")),
			("103954", "",     	Color(hex: "103954")),

			("FF6666", "",     	Color(hex: "FF6666")),
			("00CC66", "",     	Color(hex: "00CC66")),
			("492545", "",     	Color(hex: "492545")),
			("007FFF", "",    	Color(hex: "007FFF")),
			("99004D", "",     	Color(hex: "99004D")),

			("FFB366", "",     	Color(hex: "FFB366")),
			("009999", "",     	Color(hex: "009999")),
			("994C00", "",     	Color(hex: "994C00")),
			("134CD4", "",     	Color(hex: "134CD4")),
			("4E877B", "",     	Color(hex: "4E877B")),

			("42151F", "",     	Color(hex: "42151F")),
			("FF8000", "",     	Color(hex: "FF8000")),
